local Config = {
    ...
    ServiceId       = 27452, -- Your PlatoBoost Service ID
    PlatoSecret     = "478eee99-8060-4720-a6d9-9eb8bfb6d0fa", -- Your PlatoBoost Secret Key

    -- [2] Anti-Bypass / Global Secret Variable
    Secret          = "c00l", -- This makes the script ONLY run from the key script. Even if they copy the original obfuscated script to bypass the key, they won't be able to!
    
    -- [3] Scripts & Links
    MainScriptURL   = "https://raw.githubusercontent.com/loklokmmloklokmm88-hash/keysystem/refs/heads/main/script.lua", -- The raw URL of your main script
    ...
    HubName         = "C00LKİDD HUB", -- The main title shown at the top of the GUI
    HubDescription  = "Get Key. Just 8h " -- The text shown below the title
}
